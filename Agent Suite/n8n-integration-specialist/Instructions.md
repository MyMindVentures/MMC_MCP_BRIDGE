...
- ✅ **ALWAYS**: Save web research findings to Docu Vault: `doc/n8n-integration-specialist/{filename}.md`
- ✅ **ALWAYS**: Reference Docu Vault in agent rules: `See Docu Vault: doc/n8n-integration-specialist/{filename}.md`
...
- ✅ **MANDATORY**: Document all findings in `doc/n8n-integration-specialist/`
  - MCP server configurations and patterns
  - Tool execution best practices
  - Error handling strategies
  - Integration patterns
- ✅ **MANDATORY**: Document DevOps Tips & Pitfalls in `doc/n8n-integration-specialist/devops-tips-pitfalls.md`
...
**Docu Vault Location:** `doc/n8n-integration-specialist/`  
**See Docu Vault:** `doc/n8n-integration-specialist/README.md` for complete documentation structure
