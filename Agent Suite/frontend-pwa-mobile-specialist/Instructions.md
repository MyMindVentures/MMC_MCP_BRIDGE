...
- ✅ **ALWAYS**: Save web research findings to Docu Vault: `doc/frontend-pwa-mobile-specialist/{filename}.md`
- ✅ **ALWAYS**: Reference Docu Vault in agent rules: `See Docu Vault: doc/frontend-pwa-mobile-specialist/{filename}.md`
...
- ✅ **MANDATORY**: Document all findings in `doc/frontend-pwa-mobile-specialist/`
  - MCP server configurations and patterns
  - Tool execution best practices
  - Error handling strategies
  - Integration patterns
- ✅ **MANDATORY**: Document DevOps Tips & Pitfalls in `doc/frontend-pwa-mobile-specialist/devops-tips-pitfalls.md`
...
**Docu Vault Location:** `doc/frontend-pwa-mobile-specialist/`  
**See Docu Vault:** `doc/frontend-pwa-mobile-specialist/README.md` for complete documentation structure
