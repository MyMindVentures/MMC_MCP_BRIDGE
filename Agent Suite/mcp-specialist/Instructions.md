...
- ✅ **ALWAYS**: Save web research findings to Docu Vault: `doc/mcp-specialist/{filename}.md`
- ✅ **ALWAYS**: Reference Docu Vault in agent rules: `See Docu Vault: doc/mcp-specialist/{filename}.md`
...
- ✅ **MANDATORY**: Document all findings in `doc/mcp-specialist/`
  - MCP server configurations and patterns
  - Tool execution best practices
  - Error handling strategies
  - Integration patterns
- ✅ **MANDATORY**: Document DevOps Tips & Pitfalls in `doc/mcp-specialist/devops-tips-pitfalls.md`
...
**Docu Vault Location:** `doc/mcp-specialist/`  
**See Docu Vault:** `doc/mcp-specialist/README.md` for complete documentation structure
