...
- ✅ **ALWAYS**: Save web research findings to Docu Vault: `doc/code-implementation-specialist/{filename}.md`
- ✅ **ALWAYS**: Reference Docu Vault in agent rules: `See Docu Vault: doc/code-implementation-specialist/{filename}.md`
...
- ✅ **MANDATORY**: Document all findings in `doc/code-implementation-specialist/`
  - MCP server configurations and patterns
  - Tool execution best practices
  - Error handling strategies
  - Integration patterns
- ✅ **MANDATORY**: Document DevOps Tips & Pitfalls in `doc/code-implementation-specialist/devops-tips-pitfalls.md`
...
**Docu Vault Location:** `doc/code-implementation-specialist/`  
**See Docu Vault:** `doc/code-implementation-specialist/README.md` for complete documentation structure
