...
- ✅ **ALWAYS**: Save web research findings to Docu Vault: `Agent Suite/agent-orchestrator/Docu Vault/{filename}.md`
- ✅ **ALWAYS**: Reference Docu Vault in agent rules: `See Docu Vault: `Agent Suite/agent-orchestrator/Docu Vault/README.md` for complete documentation structure
...
- ✅ **MANDATORY**: Maintain all files in \`Agent Suite/agent-orchestrator/\`
  - Keep Role Description.md up-to-date
  - Update Instructions.md when workflows change
  - Maintain .cursor/rules/agent-orchestrator.mdc with current constraints
...
- ✅ **MANDATORY**: Continuous self-learning and knowledge improvement
  - Document problems in \`Agent Suite/agent-orchestrator/Self-Learning/Troubleshooting.md\`
...
**Self-Learning Location:** \`Agent Suite/agent-orchestrator/Self-Learning/\`
**Troubleshooting Log:** \`Agent Suite/agent-orchestrator/Self-Learning/Troubleshooting.md\`
...
- ✅ **MANDATORY**: Document all findings in `Agent Suite/agent-orchestrator/Docu Vault/`
  - MCP server configurations and patterns
  - Tool execution best practices
  - Error handling strategies
  - Integration patterns
- ✅ **MANDATORY**: Document DevOps Tips & Pitfalls in `Agent Suite/agent-orchestrator/Docu Vault/devops-tips-pitfalls.md`
...
**Docu Vault Location: `Agent Suite/agent-orchestrator/Docu Vault/`
**See Docu Vault: `Agent Suite/agent-orchestrator/Docu Vault/README.md` for complete documentation structure
