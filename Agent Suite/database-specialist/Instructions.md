...
- ✅ **ALWAYS**: Save web research findings to Docu Vault: `doc/database-specialist/{filename}.md`
- ✅ **ALWAYS**: Reference Docu Vault in agent rules: `See Docu Vault: doc/database-specialist/{filename}.md`
...
- ✅ **MANDATORY**: Document all findings in `doc/database-specialist/`
  - MCP server configurations and patterns
  - Tool execution best practices
  - Error handling strategies
  - Integration patterns
- ✅ **MANDATORY**: Document DevOps Tips & Pitfalls in `doc/database-specialist/devops-tips-pitfalls.md`
...
**Docu Vault Location:** `doc/database-specialist/`  
**See Docu Vault:** `doc/database-specialist/README.md` for complete documentation structure
