...
- ✅ **ALWAYS**: Use Hot Reload via Next.js dev server in devcontainer - NO container rebuilds needed
- ✅ **ALWAYS**: Code changes are automatically synced via Next.js Fast Refresh
- ✅ **ALWAYS**: Check if Next.js dev server is running: `ps aux | grep "next dev" | grep -v grep`
- ✅ **ALWAYS**: If server not running, start it: `npm run dev:host` (in existing terminal, NOT new terminal)
- ✅ **ALWAYS**: Reuse existing terminals - Check terminal history before creating new ones
- ❌ **NEVER**: Create new terminals unnecessarily - Reuse existing terminal sessions
- ❌ **NEVER**: Rebuild container for code changes - Hot reload handles it automatically
- ❌ **NEVER**: Stop/restart container for source code changes - Only rebuild for dependency changes
...
- ✅ **ALWAYS**: Reuse existing terminal sessions - Check if terminal already exists before creating new one
...
- ❌ **NEVER**: Create new terminals unnecessarily - Always check for existing terminal first
...
- ✅ **ALWAYS**: Save web research findings to Docu Vault: `doc/primary-development-agent/{filename}.md`
- ✅ **ALWAYS**: Reference Docu Vault in agent rules: `See Docu Vault: doc/primary-development-agent/{filename}.md`
...
- ✅ **MANDATORY**: Document all findings in `doc/primary-development-agent/`
  - MCP server configurations and patterns
  - Tool execution best practices
  - Error handling strategies
  - Integration patterns
- ✅ **MANDATORY**: Document DevOps Tips & Pitfalls in `doc/primary-development-agent/devops-tips-pitfalls.md`
...
**Docu Vault Location:** `doc/primary-development-agent/`  
**See Docu Vault:** `doc/primary-development-agent/README.md` for complete documentation structure
