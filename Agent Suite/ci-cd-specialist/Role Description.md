...
- ✅ **ALWAYS**: Save web research findings to Docu Vault: `Agent Suite/ci-cd-specialist/Docu Vault/{filename}.md`
- ✅ **ALWAYS**: Reference Docu Vault in agent rules: `See Docu Vault: `Agent Suite/ci-cd-specialist/Docu Vault/README.md` for complete documentation structure
...
- ✅ **MANDATORY**: Maintain all files in \`Agent Suite/ci-cd-specialist/\`
  - Keep Role Description.md up-to-date
  - Update Instructions.md when workflows change
  - Maintain .cursor/rules/ci-cd-specialist.mdc with current constraints
...
- ✅ **MANDATORY**: Continuous self-learning and knowledge improvement
  - Document problems in \`Agent Suite/ci-cd-specialist/Self-Learning/Troubleshooting.md\`
...
**Self-Learning Location:** \`Agent Suite/ci-cd-specialist/Self-Learning/\`
**Troubleshooting Log:** \`Agent Suite/ci-cd-specialist/Self-Learning/Troubleshooting.md\`
...
- ✅ **MANDATORY**: Document all findings in `Agent Suite/ci-cd-specialist/Docu Vault/`
  - MCP server configurations and patterns
  - Tool execution best practices
  - Error handling strategies
  - Integration patterns
- ✅ **MANDATORY**: Document DevOps Tips & Pitfalls in `Agent Suite/ci-cd-specialist/Docu Vault/devops-tips-pitfalls.md`
...
**Docu Vault Location: `Agent Suite/ci-cd-specialist/Docu Vault/`
**See Docu Vault: `Agent Suite/ci-cd-specialist/Docu Vault/README.md` for complete documentation structure
