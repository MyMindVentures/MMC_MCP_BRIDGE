...
- ✅ **ALWAYS**: Save web research findings to Docu Vault: `doc/doppler-credentials-specialist/{filename}.md`
- ✅ **ALWAYS**: Reference Docu Vault in agent rules: `See Docu Vault: doc/doppler-credentials-specialist/{filename}.md`
...
- ✅ **MANDATORY**: Document all findings in `doc/doppler-credentials-specialist/`
  - MCP server configurations and patterns
  - Tool execution best practices
  - Error handling strategies
  - Integration patterns
- ✅ **MANDATORY**: Document DevOps Tips & Pitfalls in `doc/doppler-credentials-specialist/devops-tips-pitfalls.md`
...
**Docu Vault Location:** `doc/doppler-credentials-specialist/`  
**See Docu Vault:** `doc/doppler-credentials-specialist/README.md` for complete documentation structure
