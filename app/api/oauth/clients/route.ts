...
export async function POST(request: Request) {
  ...
  try {
      ...
      return NextResponse.json(
        {
          ...
          error_description:
            "Missing required fields: name, redirectUris, grants",
        },
        { status: 400 },
      );
    }
    ...
    const clientId =
      "mmc_oauth2_client_" + crypto.randomBytes(16).toString("hex");
    const clientSecret =
      "mmc_oauth2_secret_" + crypto.randomBytes(32).toString("hex");
