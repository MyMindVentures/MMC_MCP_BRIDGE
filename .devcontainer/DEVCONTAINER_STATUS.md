...
- `Dockerfile.dev` → Vervangen door `containers/dev/Dockerfile`
- `Dockerfile.e2e` → Vervangen door `containers/e2e/Dockerfile`
- `Dockerfile.prod` → Vervangen door `containers/app/Dockerfile`
- `build-app-container.sh` → Vervangen door `containers/app/build.sh`
- `build-e2e-container.sh` → Vervangen door `containers/e2e/build.sh`
